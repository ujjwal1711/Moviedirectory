package volley.com.volleyapplication.app.moviedirectory.Activities;
...
import volley.com.volleyapplication.app.moviedirectory.Data.Movierecycleradapter;
...
import volley.com.volleyapplication.app.moviedirectory.Util.Constants;
import volley.com.volleyapplication.app.moviedirectory.Util.Pref;

public class MainActivity extends AppCompatActivity {
    private RecyclerView recyclerView;
    private Movierecycleradapter movieRecyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        movieRecyclerViewAdapter = new Movierecycleradapter(this, movieList );
    ...
    public List<Movie> getMovies(final String searchTerm) {
        ...
        JsonObjectRequest jsonObjectRequest= new JsonObjectRequest(Request.Method.GET ,Constants.URL_LEFT + searchTerm + Constants.URL_RIGHT+Constants.API_KEY, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try{
                    Log.d("URL",Constants.URL_LEFT+searchTerm+Constants.URL_RIGHT);
    ...
    public void showinputdialog()
    {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Pref prefs = new Pref(MainActivity.this);
